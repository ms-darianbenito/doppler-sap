...
namespace Doppler.Sap.Test.Controllers
{
    ...
    {
        Mock<ILogger<BillingController>> loggerMock;

        public BillingControllerTest()
        {
            loggerMock = new Mock<ILogger<BillingController>>();
        }

        [Fact]
        public void SetCurrencyRate_ShouldBeHttpStatusCodeOk_WhenCurrencyRateValid()
        {
            BillingController controller = new BillingController(loggerMock.Object);
